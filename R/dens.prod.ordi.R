...
# Version 1.1: correction d'erreurs qui donnaient une probabilite erronee avec 
# des covariables: ajout du champ d'indices 1:(S.alp-1) et passage de covar.x comme
# un argument supplementaire a p.compute au lieu de l'additionner au vecteur alpha
